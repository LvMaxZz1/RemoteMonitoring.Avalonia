...
namespace RemoteMonitoringClient.Base.Network.Handlers;
...
public class VerifyNetworkMessageHandler : ICommandHandler<VerifyNetworkMessageCommand, VerifyNetworkMessageResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (msg.ReceiveMessageBytes.Length == 0 || msg.PacketHeader.LinkType is not MachineLinkType.Server and not MachineLinkType.Console)
        {
