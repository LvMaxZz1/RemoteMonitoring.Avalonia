...
public partial class HomepagePanelViewModel : ViewModelBase, IActivatableViewModel
{
    ...
    public HomepagePanelViewModel(LeftPanelViewModel leftPanelViewModel, IDeepSeekAiRefitService deepSeekAiRefitService)
    {
        ...
        MessageBusUtil.ListenMessage<MachineOnlineBusModel>(RxApp.MainThreadScheduler, MachineOnlineOnlineLog, MessageBusContract.MessageBusService);
        
        MessageBusUtil.ListenMessage<MachineExitBusModel>(RxApp.MainThreadScheduler, MachineOfflineLog, MessageBusContract.MessageBusService);
